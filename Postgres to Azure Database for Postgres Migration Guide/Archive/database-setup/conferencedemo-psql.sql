...
--------------------------------------------------------
DROP SEQUENCE IF EXISTS REG_APP.DBOBJECTID_SEQUENCE;
DROP SEQUENCE IF EXISTS REG_APP.REGISTRATION_ID_SEQ;
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  REG_APP.DBOBJECTID_SEQUENCE  MINVALUE 1 MAXVALUE 2147483647 INCREMENT BY 50 START WITH 1 CACHE 50 NO CYCLE ;
--------------------------------------------------------
--  DDL for Sequence REGISTRATION_ID_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  REG_APP.REGISTRATION_ID_SEQ  MINVALUE 1 MAXVALUE 2147483647 INCREMENT BY 1 START WITH 103 CACHE 20 NO CYCLE ;
--------------------------------------------------------
...
SET search_path TO reg_app,public;
...
Insert into REG_APP.EVENTS (ID,EVENT_NAME,EVENT_DESCRIPTION,EVENT_START_DATE,EVENT_PRICE,EVENT_END_DATE) values (1,'Ignite','Microsoft Ignite is the place to learn from the experts, connect with your community, and explore the latest technology.',to_date('21-SEP-20','DD-MON-YY'),1200,to_date('25-SEP-20','DD-MON-YY'));
...
Insert into REG_APP.SESSIONS (ID,NAME,DESCRIPTION,SESSION_DATE,SPEAKER_ID,EVENT_ID,DURATION) values (1,'Serverless Signal R','Build real time messaging applications for web and .NET',to_date('21-SEP-20','DD-MON-YY'),1,1,60);
Insert into REG_APP.SESSIONS (ID,NAME,DESCRIPTION,SESSION_DATE,SPEAKER_ID,EVENT_ID,DURATION) values (2,'Hybrid updates in Azure with Julia White','Hybrid updates in Azure with Julia White',to_date('29-MAR-19','DD-MON-YY'),2,1,45);
